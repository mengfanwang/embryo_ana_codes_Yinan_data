...
%% parameter setting
files = {{'000', '049'}, {'040', '089'}, {'080', '129'}, {'120', '169'}, ... 
         {'160', '209'}, {'200', '249'}, {'240', '309'}, {'300', '399'}, ...
         {'390', '449'}, {'440', '489'}, {'480', '529'}, {'520', '569'}, ...
         {'560', '609'}, {'600', '649'}, {'640', '689'}, {'680', '729'}, ...
         {'720', '769'}, {'760', '809'}, {'800', '849'}, {'840', '889'}, ...
         {'880', '929'}, {'920', '969'}, {'960', '1000'},};
max_dist = 100;
resolution = [2 2 4];
size_ratio = 1;
max_nei = 10;
