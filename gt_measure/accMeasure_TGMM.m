...
resolution = [1 1 5.86];
node_file = '/work/Mengfan/TGMM2.0/Outputs/Tracking_results/21-01-11/MastodonTable-Spot.csv';
edge_file = '/work/Mengfan/TGMM2.0/Outputs/Tracking_results/21-01-11/MastodonTable-Link.csv';
