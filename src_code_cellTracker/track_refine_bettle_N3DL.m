...
if isunix
    ...
    if cropped_flag 
        ...
        timepts_to_process = generate_tps_str(000:079);
        wei_refine_res_folder = "/work/Mengfan/EmbryoData_other/Fluo-N3DL-TRIF_train/02_detection/Wei_refine_res";
        save_folder = '/work/Mengfan/EmbryoData_other/Fluo-N3DL-TRIF_train/02_Tracking/0208_000_079';
    end
...
if cropped_flag
    ...
    cell_seg_res_folder = save_folder;
     ...
     data_folder = '/work/Mengfan/EmbryoData_other/Fluo-N3DL-TRIF_train/02_data';
     cell_seg_res_folder = '/work/Mengfan/EmbryoData_other/Fluo-N3DL-TRIF_train/02_detection';
...
g.translation_path = '/work/Mengfan/EmbryoData_other/Fluo-N3DL-TRIF_train/02_Registration';
...
g.driftInfo.batch_size = [30 16 16];
% g.resolution = [1 1 5.86];

if ~all(g.driftInfo.grid_size .*g.driftInfo.batch_size == [960 512 512])
...
if ~isempty(st_loc)  % adjust if crop
    ...
    z_batch = z_batch*g.driftInfo.batch_size(3) + 0.5 - g.driftInfo.batch_size(3)/2 - st_loc(3)/sc_f;
else
