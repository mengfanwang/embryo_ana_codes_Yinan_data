...
%     [~, ratio_mat, track_id_head, ~] = validate_res(movieInfo_noJump, gt_tracks_ov);
%     test_track_id = track_id_head(38);
%     display_track_link(movieInfo_noJump, test_track_id,refine_res, embryo_vid);
...
fprintf('we merged %d regions, separate %d regions\n', ...
