...
if isunix
    ...
    if cropped_flag
        ...
        timepts_to_process = generate_tps_str(160:179);
%         timepts_to_process = generate_tps_str(121:160);
        wei_refine_res_folder = "/work/Mengfan/Embryo/23-11-01_Yinan/Detection_view9/Wei_refine_res";
        save_folder = '/work/Mengfan/Embryo/23-11-01_Yinan/Tracking/view9_1123_160_179';
...
if cropped_flag
    ...
    cell_seg_res_folder = save_folder;
     ...
     cell_seg_res_folder = '/work/Mengfan/Embryo/23-11-01_Yinan/Detection_view9';
...
g.translation_path = '/work/Mengfan/Embryo/23-11-01_Yinan/Registration';
