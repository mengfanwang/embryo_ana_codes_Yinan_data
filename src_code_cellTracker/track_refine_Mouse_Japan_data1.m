...
if isunix
    ...
    timepts_to_process = generate_tps_str(1:151);
    wei_refine_res_folder = "/work/Mengfan/EmbryoData_other/Mouse_Japan/embryo1-embryo1_Vertical-gfp_detection_removal/Wei_refine_res";
    save_folder = '/work/Mengfan/EmbryoData_other/Mouse_Japan/embryo1-embryo1_Vertical-gfp_Tracking/0817_001_151';
...
cell_seg_res_folder = '/work/Mengfan/EmbryoData_other/Mouse_Japan/embryo1-embryo1_Vertical-gfp_detection_removal';
...
for i=1:numel(tif_files)
    ...
    embryo_vid_temp{1} = embryo_vid_temp{1} - 400;
    embryo_vid_temp{1}(embryo_vid_temp{1}<0) = 0;  
...
g.translation_path = '/work/Mengfan/EmbryoData_other/Mouse_Japan/embryo1-embryo1_Vertical-gfp_detection_removal/Registration';
g.driftInfo.grid_size = 32;    % vector numbers each dim, currently cube only
g.driftInfo.batch_size = [32 32 2];
% g.resolution = [1 1 5.86];

if ~all(g.driftInfo.grid_size .*g.driftInfo.batch_size == [1024 1024 64])
...
mat2tgmm(movieInfo, fullfile(mastodon_dir, 'tgmm_format'), [1 1 1]);
