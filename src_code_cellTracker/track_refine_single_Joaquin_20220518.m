...
if isunix
    ...
    if cropped_flag
        ...
        wei_refine_res_folder = "/work/Mengfan/Embryo/20220518 isl2b H2Bmcherry overnight/Detection_view11/Wei_refine_res";
        save_folder = '/work/Mengfan/Embryo/20220518 isl2b H2Bmcherry overnight/Tracking/view11_0221_0_19';
    end
...
if cropped_flag
    ...
    cell_seg_res_folder = save_folder;
     ...
     data_folder = '/work/Mengfan/Embryo/20220518 isl2b H2Bmcherry overnight/view11';
     cell_seg_res_folder = '/work/Mengfan/Embryo/20220518 isl2b H2Bmcherry overnight/Detection_view11';
...
g.translation_path = '/work/Mengfan/Embryo/20220518 isl2b H2Bmcherry overnight/Registration_view11';
...
if ~all(g.driftInfo.grid_size .*g.driftInfo.batch_size == [960 960 256])
