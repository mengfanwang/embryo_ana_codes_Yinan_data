...
g.translation_path = '/work/Mengfan/EmbryoData_other/drosophila-cell-tracking/Our/Registration';
% g.translation_path = '/work/Mengfan/Embryo/Registration/nonrigid_result_view11_l5_s1_linear_debug';
g.driftInfo.grid_size = 8;    % vector numbers each dim, currently cube only
g.driftInfo.batch_size = [40 96 4];
% g.resolution = [1 1 5.86];

if ~all(g.driftInfo.grid_size .*g.driftInfo.batch_size == [320 768 32])
