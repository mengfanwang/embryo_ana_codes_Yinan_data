function movieInfo = mergeBrokenTracksV3(movieInfo, g)
...
% V2: 1: check jump 2: use distance rather than overlap to link
% broken tracks
% V3 (this): Re-find neighbor and select the best neighbor 
