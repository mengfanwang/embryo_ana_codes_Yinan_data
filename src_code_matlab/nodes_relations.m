...
% calculating overlapping size distance and cost between two nodes
...
%         frame_shift = movieInfo.drift(movieInfo.frames(neiNode),:) ...
%             - movieInfo.drift(movieInfo.frames(curNode),:);
